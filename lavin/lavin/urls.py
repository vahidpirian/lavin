...
from .views import Home_Page, About_Us, Gallery_List_partial, Article_List_partial
...
urlpatterns = [
    ...
    path('article_list_partial', Article_List_partial, name="article_list_partial"),
